...
- **Physics-informed modelling** — incorporating physical knowledge into data-driven prediction.
- **Explainable machine learning** — examining the relationships learned by predictive models and assessing their physical plausibility.
- **Predictive reliability** — evaluating robustness and generalization, including spatially structured validation where appropriate.
...
[Email](mailto:tianlong_wang@zju.edu.cn) · [Google Scholar](https://scholar.google.com/citations?user=JNiHto0AAAAJ) · [ORCID](https://orcid.org/0000-0002-0598-5481) · [GitHub](https://github.com/zjusuge) · [ResearchGate](https://www.researchgate.net/profile/Tianlong-Wang-7) · [LinkedIn](https://www.linkedin.com/in/tianlong-wang/)

**On this page:**  
[Publications](#publications) · [Research Software](#research-software) · [Education](#education) · [Funding](#research-funding) · [Patents](#patents) · [Honors](#honors) · [Competitions](#competitions) · [Beyond Research](#beyond-research) · [Contact](#contact)
...
**Regional debris-flow susceptibility assessment**

A dynamic optimization meta-ensemble framework combining learner screening, ensemble optimization, out-of-fold stacking, isotonic calibration, and spatially blocked validation. The workflow includes documented debris-flow inventory records and pseudo-absence generation, with SHAP-based interpretation of model predictions.

[Repository](https://github.com/zjusuge/DOME_Dynamic-Optimization-Meta-Ensemble-Framework-for-Computational-Debris-Flow-Risk-Assessment) · [Paper](https://doi.org/10.1007/s11069-026-08307-2) · [Archived release](https://doi.org/10.5281/zenodo.16911533)

## TabPFNv2.5-DebrisFlow

**Small-sample debris-flow volume prediction**

A benchmark of zero-shot TabPFN-2.5 against Bayesian-optimised machine learning baselines for catchment-scale debris-flow volume prediction, evaluated using repeated nested cross-validation.

[Repository](https://github.com/zjusuge/TabPFNv2.5-DebrisFlow)

## BWSD — Fengshuwan Case Study

**Catchment water-storage calculation**
...
**Short-lead hydrological prediction**
